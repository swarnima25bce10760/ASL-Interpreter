  ...
  return (
    <div style={{ marginTop: "2em" }}>
      <div className="jumbotron text-center">
        <h1>Finger Wizard - ASL Translator</h1>
        <h4>
          Finger Wizard uses machine learning to transform webcam input into
          readable sign language using a variety of different techniques. The
          series of texts below detail the steps taken for Finger Wizard to
